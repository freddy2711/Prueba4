...
import RecuperarButtons from './RecuperarButtons'
import styles from './RecuperarButtons.module.scss'
...
storiesOf('Molecules/RecuperarButtons', module)
  .addDecorator((Story) => (
  ...
  .add('RecuperarButtons', () => <RecuperarButtons />)
